...
See [PLUGINS.md](PLUGINS.md) for the full plugin API reference — manifests, transports (HTTP, Unix socket, STDIO), response shapes, and complete examples.

### Quick start

Open **Settings → Plugins**, paste the plugin URL, and press Enter. No restart needed.
